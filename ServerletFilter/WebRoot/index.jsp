...
<link rel="apple-touch-icon"
	href="Content/assets/ico/apple-touch-icon.png" />
<link rel="apple-touch-icon" sizes="57x57"
	href="Content/assets/ico/apple-touch-icon-57x57.png" />
<link rel="apple-touch-icon" sizes="72x72"
	href="Content/assets/ico/apple-touch-icon-72x72.png" />
<link rel="apple-touch-icon" sizes="76x76"
	href="Content/assets/ico/apple-touch-icon-76x76.png" />
<link rel="apple-touch-icon" sizes="114x114"
	href="Content/assets/ico/apple-touch-icon-114x114.png" />
<link rel="apple-touch-icon" sizes="120x120"
	href="Content/assets/ico/apple-touch-icon-120x120.png" />
<link rel="apple-touch-icon" sizes="144x144"
	href="Content/assets/ico/apple-touch-icon-144x144.png" />
<link rel="apple-touch-icon" sizes="152x152"
	href="Content/assets/ico/apple-touch-icon-152x152.png" />
...
<link href="Content/assets/vendor/bootstrap/css/bootstrap.min.css"
	rel="stylesheet" />
<link href="Content/assets/vendor/skycons/css/skycons.css"
	rel="stylesheet" />
<link href="Content/assets/vendor/font-awesome/css/font-awesome.min.css"
	rel="stylesheet" />

<!-- Plugins CSS-->

<!-- Theme CSS -->
<link href="Content/assets/css/jquery.mmenu.css" rel="stylesheet" />

<!-- Page CSS -->
<link href="Content/assets/css/style.css" rel="stylesheet" />
<link href="Content/assets/css/add-ons.min.css" rel="stylesheet" />
...
<body>
			...
			<div class="body-login">
				<div class="center-login">
					<a href="#" class="logo pull-left hidden-xs"> <img
						src="Content/assets/img/th2.png" height="45" alt="在线" />
					</a>
					...
					<div class="panel panel-login">
						...
						<div class="panel-body">
							<form action="welcome" method="post">
								...
								<br />
								<p class="text-center">
									Don't have an account yet? <a href="page-register.html"><small>Register!</small>
									</a>-->
							</form>
						</div>
					</div>
	...
	<script src="Content/assets/vendor/js/jquery-2.1.1.min.js"></script>
	<script src="Content/assets/vendor/js/jquery-migrate-1.2.1.min.js"></script>
	<script src="Content/assets/vendor/bootstrap/js/bootstrap.min.js"></script>
	<script src="Content/assets/vendor/skycons/js/skycons.js"></script>
	...
	<!-- Pages JS -->
	<script src="Content/assets/js/pages/page-login.js"></script>
