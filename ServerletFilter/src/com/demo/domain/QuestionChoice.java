...
public class QuestionChoice  implements java.io.Serializable {
	...
	/** minimal constructor */
    public QuestionChoice(String content, String optionA, String optionB, String optionC, String optionD, String answer, String difficultyPonit) {
    ...
    /** full constructor */
    public QuestionChoice(String content, String optionA, String optionB, String optionC, String optionD, String optionE, String answer, String difficultyPonit) {
        this.content = content;
        this.optionA = optionA;
        this.optionB = optionB;
        this.optionC = optionC;
